...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* MOBILE DRAWER */}
      <aside
        className={`fixed inset-y-0 right-0 z-[95] flex w-[84vw] max-w-[390px] flex-col border-l border-white/[.04] bg-[#020617]/[.98] backdrop-blur-2xl transition-transform duration-300 ease-[cubic-bezier(.4,0,.2,1)] lg:hidden ${
