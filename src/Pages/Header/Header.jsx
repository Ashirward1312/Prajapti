...
export default function Header() {
  ...
  /**
   * ✅ FIX: "Light jada aa raha hai"
   * - Home page: top par transparent (hero mix), scroll par dark blur
   * - Other pages (Services/About/Contact/Product): top par bhi DARK glass (so white bg through nahi dikhega)
   */
  const headerShellClass =
    isHome && !scrolled
      ? "bg-transparent"
      : "bg-[#020617]/92 shadow-2xl shadow-black/30 backdrop-blur-2xl border-b border-white/[.04]";
        ...
        <nav className="mx-auto flex h-[74px] sm:h-[82px] max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:h-[92px] lg:px-8">
          ...
          >
            <div className="relative flex-shrink-0">
              <div className="relative h-12 w-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 overflow-hidden rounded-2xl border-2 transition-all duration-300 group-hover:scale-110 group-active:scale-95 border-sky-500/20 bg-sky-950/50 shadow-lg shadow-sky-500/10 group-hover:border-sky-400/50 group-hover:shadow-sky-400/25">
                <img
                  src={logo}
              ...
              <div className="pointer-events-none absolute -inset-2 rounded-[22px] transition-all duration-500 bg-sky-400/0 group-hover:bg-sky-400/10 blur-lg" />

              <div className="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 transition-all duration-300 border-slate-900 bg-sky-400 shadow-sm shadow-sky-400/50 group-hover:scale-125" />
            </div>

            <div className="flex flex-col leading-none">
              <span className="text-[15px] sm:text-[18px] lg:text-[21px] font-black tracking-tight uppercase transition-colors duration-300 text-white">
                PRAJAPATI{" "}
                <span className="text-sky-400 hidden sm:inline">ENTERPRISE</span>
                <span className="text-sky-400 sm:hidden">E.</span>
              </span>

              <span className="hidden sm:block text-[10px] lg:text-[11px] font-semibold tracking-[1px] uppercase mt-1 transition-colors duration-300 text-slate-400">
            ...
            {NAV_LINKS.map((link) => (
              <li key={link.label}>
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-3 right-3 h-[2px] rounded-full transition-all duration-300 bg-sky-400 ${
                      activeSection === link.href
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 flex-shrink-0">
            ...
            <a
              href={`tel:${PHONE}`}
              className="hidden lg:inline-flex items-center gap-2.5 rounded-xl border px-4 py-2.5 text-[14px] font-medium transition-all duration-300 border-white/[.06] bg-white/[.03] text-slate-300 hover:border-sky-500/20 hover:bg-sky-500/8 hover:text-sky-300"
            >
            ...
            <a
              href={`tel:${PHONE}`}
              className="inline-flex lg:hidden items-center justify-center rounded-xl border p-2.5 sm:p-3 transition-all duration-200 active:scale-95 border-white/[.06] bg-white/[.03] text-sky-400 hover:bg-sky-500/10 hover:border-sky-500/20"
              aria-label="Call us"
            >
              <svg
            ...
            <button
              ...
              className="relative z-[101] flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-xl border transition-all active:scale-95 lg:hidden cursor-pointer border-white/[.06] bg-white/[.03] hover:bg-sky-500/10 hover:border-sky-500/20"
            >
              <div className="flex h-[16px] w-[18px] flex-col justify-between">
                <span
                  className={`block h-[2px] w-full rounded-full transition-all duration-300 origin-center bg-white ${
                    mobileOpen ? "translate-y-[7px] rotate-45" : ""
                  }`}
                />
                <span
                  className={`block h-[2px] rounded-full transition-all duration-300 bg-white ${
